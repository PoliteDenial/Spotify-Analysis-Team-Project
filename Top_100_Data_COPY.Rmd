...
df <- df %>% mutate(song_name = (names), artist_name = artist_names) %>% relocate(artist_name) %>% relocate(song_name)
tracks = df
...
write.csv(trackDf,"C:\\Users\\avery\\OneDrive\\Documents\\GitHub\\spotify_data_proj\\test.csv")
```
