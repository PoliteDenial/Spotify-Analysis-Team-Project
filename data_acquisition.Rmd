...
```{r} 
#Again all function work this is commented out just to knit without it re generating our csv
...
#res = write.csv(trackDf,path_to_csv) #Again works commented out just to knit
```
